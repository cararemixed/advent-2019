defmodule AnswersTest do
  ...
  test "star 7" do
    assert Advent.star7() == 511
  end

  test "star 8" do
    assert Advent.star8() == 316
  end

  test "star 9" do
    assert Advent.star9() == 5_577_461
  end

  test "star 10" do
    assert Advent.star10() == 7_161_591
  end

  test "star 11" do
    assert Advent.star11() == 160_040
  end
  ...
  test "star 14" do
    assert Advent.star14() == 14_260_332
  end

  test "star 15" do
    assert Advent.star15() == 1620
  end

  test "star 16" do
    assert Advent.star16() == """
           ###   ##  #   ##### #### \n\
           #  # #  # #   ##    #    \n\
           ###  #     # # ###  ###  \n\
           #  # #      #  #    #    \n\
